...
Load the text of Pride & Prejudice into R using the `janeaustenr` library. Then download and read the
...
also goes by the names "Mr. Darcy", and "Mr. Fitzwilliam Darcy" (not to be confused with his cousin "Colonel Fitzwilliam"). Process the text of Pride & Prejudice to replace instances where an 
