...
modest_proposal |> 
  inner_join(get_sentiments("afinn")) |> summarise(sentiment = sum(value)/n())
...
```{r}
#| echo: true
shakespeare <-  gutenberg_download(c("2266","2265","2264","2267"),
                                   meta_fields = "title")
shakespeare |> unnest_tokens(bigram,text,token = "ngrams",n=2)
```
